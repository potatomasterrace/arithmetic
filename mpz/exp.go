...
func (m Mpz) MpzPowUi(bitcnt C.ulong) (Mpz, error) {
...
func (m Mpz) MpzPowM(exp Mpz, mod Mpz) (Mpz, error) {
...
func (m Mpz) MpzPowMSec(exp Mpz, mod Mpz) (Mpz, error) {
...
func (m Mpz) MpzPowMUi(exp C.ulong, mod Mpz) (Mpz, error) {
